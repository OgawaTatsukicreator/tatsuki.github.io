(() => {
  ...
  const home = {
    ...
    "アルバイト先のシフト提出システム、育成型筋トレ日記「マソ君の日常」などの制作物と、コンテストやインターンでの経験をまとめています。": "See my shift submission system, the gamified workout diary Maso-kun's Daily Life, and my experience in competitions and internships.",
